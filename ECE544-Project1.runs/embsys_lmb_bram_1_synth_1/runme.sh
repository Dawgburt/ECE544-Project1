...
HD_PWD='C:/ECE544-EmbeddedSystemsFPGA/ece544w25_proj1/ECE544-Project1/ECE544-Project1.runs/embsys_lmb_bram_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embsys_lmb_bram_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embsys_lmb_bram_1.tcl
